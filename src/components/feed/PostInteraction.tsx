     ...
     <div className='flex items-center justify-between text-sm my-4'>
            <div className='flex gap-8'>
                <div className='flex items-center gap-4 bg-slate-50 p-2 rounded-xl'>
                    <form action={likeAction}><button>
                    <Image src={optimisticLike.isLiked ? "/like.png" : "/like.png"} width={16} height={16} alt='' className='cursor-pointer'/>
                    </button></form>
                    <span className='text-gray-600'>|</span>
                    <span className='text-gray-700'>{optimisticLike.likeCount} <span className='hidden md:inline'> likes</span></span>
            ...
            <div className='flex items-center gap-4 bg-slate-100 p-2 rounded-xl'>
                    ...
                    <span className='text-gray-600'>|</span>
                    <span className='text-gray-700'> <span className='hidden md:inline'> Share</span></span>
                </div>
            </div>
        </div>

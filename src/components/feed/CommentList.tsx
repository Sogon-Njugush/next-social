...
const CommentList = ({comments, postId}:{comments:commentWithUser[],postId:number}) => {
  ...
  return (
    ...
    <Image src={user?.imageUrl || "/noAvatar.png"} alt="" className="w-8 h-8 rounded-full" width={32} height={32}/>
...
<div className="">
    ...
    <div className="flex gap-4 justify-between mt-6" key={comment.id}>
        <Image src={comment.user.avatar || "/noAvatar.png"} alt="" className="w-10 h-10 rounded-full" width={40} height={40}/>
        {/* DESCRIPTION*/}
